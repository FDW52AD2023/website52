...
const app5BtnAplicar = document.getElementById("app5BtnAplicarborde");
const app5Divprueba = document.getElementById("divPrueba");
app5BtnAplicar.addEventListener("click", (e) => {
    ...
    app5Divprueba.style.setProperty(borde, `${color} ${grosor} ${tipo}`);
